 ...
 * 数据库操作
 *
 * @version        $Id: sys_data.done.php 1 17:19 2010年7月20日Z tianya $
...
if($dopost=='bak')
{
    ...
    if($nowtable=='')
    {
        ...
        $doneForm = "<form name='gonext' method='post' action='sys_data.done.php'>
    ...
    else
    {
        ...
        $tmsg = "<font color='red'>完成到{$m}条记录的备份，继续备份{$nowtable}...</font>";
        $doneForm = "<form name='gonext' method='post' action='sys_data.done.php?dopost=bak'>
          <input type='hidden' name='isstruct' value='$isstruct' />
          <input type='hidden' name='fsize' value='$fsize' />
          <input type='hidden' name='tablearr' value='$tablearr' />
          <input type='hidden' name='nowtable' value='$nowtable' />
...
else if($dopost=='redat')
{
    ...
    if($startgo==0 && $structfile!='')
    {
        ...
        $doneForm = "<form name='gonext' method='post' action='sys_data.done.php?dopost=redat'>
