...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D6D6D6">
  ...
  <tr>
    ...
    <table width="100%" border="0"  cellspacing="0" cellpadding="0" style="text-align:left;background:#ffffff;">
        <form name="form1" action="c_check_1.php" method="post"  >
          ...
          <tr>
            ...
            <td  class="bline"><?php
                    $nowtime =date("Y-m", time());
                          ?>
              <input type="text" name="checkdate" size="14" value="<?php echo $nowtime;?>" readonly="readonly" class="Wdate"  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM'})"/></td>
