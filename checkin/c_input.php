 ...
 * 添加
 *
 * @version        $Id: c_input.php 1 16:22 2010年7月20日Z tianya $
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D6D6D6">
  ...
  <tr>
    <td  align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0"  cellspacing="0" cellpadding="0" style="text-align:left;background:#ffffff;">
        <form name="form1" action="c_input_1.php" method="post"   >
          <tr>
            <td  width="10%" class="bline" align="right">&nbsp;<b>选择月份</b>：</td>
            <td  class="bline"><?php $nowtime =date("Y-m", time());?>
          ...
          <tr  bgcolor="#F9FCEF">
            <td height="45"></td>
            <td ><input name="imageField" type="image" src="../images/button_ok.gif" width="60" height="22" border="0" class="np" /></td>
          </tr>
        </form>
      </table></td>
  </tr>
