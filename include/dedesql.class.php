...
class DedeSql
{
    ...
    function Execute($id="me", $sql='')
    {
        ...
        //}
       // dump(empty($this->result[$id]));
        //if(!empty($this->result[$id]) && $this->result[$id]===false)原为这句，但!empty($this->result[$id])当执行有错误时，一直判断为false，输出不了错误 删除掉这句141021
    ...
    {
        //dump($this->dbName." --- ".$tbname." --- ".$this->linkID);
