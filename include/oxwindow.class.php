...
class OxWindow
{
    ...
    function AddTitle($title, $col="2")
    {
        ...
        $this->myWinItem .= "<td $colspan background='../images/wbg.gif' height='26'><font color='#666600'><b>$title</b></font></td>\r\n";
        $this->myWinItem .= "</tr>\r\n";
    }
...
<td width='90'><input name='imageField1' type='image' class='np' src='../images/button_".$wintype.".gif' width='60' height='22' border='0' /></td>
</tr>
</table>
</td>
</tr>";

//140826重置和返回有问题 删除用的时候再说  查看原处DEDE的也不能用
//<td width='90'><a href='#'><img class='np' src='../templets/plus/img/button_reset.gif' width='60' height='22' border='0' onClick='this.myform.reset()' /></a></td>
//<td><a href='#'><img src='../templets/plus/img/button_back.gif' width='60' height='22' border='0' onClick='history.go(-1);' /></a></td>
    ...
    {
        global $wecome_info,$cfg_basedir;
        if(empty($wecome_info))
        {
            $wecome_info = " OX 通用对话框：";
        }
        ...
        {
 			//echo "1111";
   			//echo $cfg_basedir.$cfg_web_templets_dir.'/plus/win_templet.htm';
        $ctp->LoadTemplate($cfg_basedir.'/include/oxwindow_templet.htm');
        }
        else
        {
