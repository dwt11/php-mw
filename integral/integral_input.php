...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D6D6D6">
  <tr>
    <td height="30" background="../images/tbg.gif" bgcolor="#E7E7E7" style="padding-left:20px;"><b><strong>
	  <?php echo strtoupper($integral_class);
  ...
  <tr>
    ...
    <table width="100%" border="0"  cellspacing="0" cellpadding="0" style="text-align:left;background:#ffffff;">
        <form name="form1" action="integral_input_1.php" method="post"  >
          ...
          <tr>
            <td  width="10%" class="bline" align="right">&nbsp;<b>选择积分类型</b>：</td>
            <td  class="bline"><select name="integral_class">
